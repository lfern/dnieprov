 ...
 * @author luis
 */
public class DnieDriverException extends Exception{

    public DnieDriverException(Throwable cause) {
        super(cause);
    }

    public DnieDriverException(String message, Throwable cause) {
        super(message, cause);
    }

    public DnieDriverException(String message) {
        super(message);
    }
