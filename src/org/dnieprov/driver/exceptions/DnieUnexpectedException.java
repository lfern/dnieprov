 ...
 * @author luis
 */
public class DnieUnexpectedException extends DnieDriverException{

    public DnieUnexpectedException(String message) {
        super(message);
    }

    public DnieUnexpectedException(String message, Throwable cause) {
        super(message, cause);
    }

    public DnieUnexpectedException(Throwable cause) {
        super(cause);
    }
