 ...
 * @author luis
 */
public class DnieGettingCryptoProviderExcetion extends DnieDriverException{

    public DnieGettingCryptoProviderExcetion(String message) {
        super(message);
    }

    public DnieGettingCryptoProviderExcetion(String message, Throwable cause) {
        super(message, cause);
    }

    public DnieGettingCryptoProviderExcetion(Throwable cause) {
        super(cause);
    }
