 ...
 * @author luis
 */
public class DnieSettingSecureChannelException extends DnieDriverException {

    public DnieSettingSecureChannelException(String message) {
        super(message);
    }

    public DnieSettingSecureChannelException(String message, Throwable cause) {
        super(message, cause);
    }

    public DnieSettingSecureChannelException(Throwable cause) {
        super(cause);
    }
