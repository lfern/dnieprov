 ...
 * @author luis
 */
public class DnieKeyNotFoundException extends DnieDriverException{

    public DnieKeyNotFoundException(String message) {
        super(message);
    }

    public DnieKeyNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }

    public DnieKeyNotFoundException(Throwable cause) {
        super(cause);
    }
