 ...
 * @author luis
 */
final class PasswordConsoleCallback implements PasswordCallback{
    
    @Override
    public char[] getPassword(String title,String msg) throws DnieUnexpectedException{
        Console console = System.console();
        if (console == null) {
            System.out.println("Cannot get the console object");
            throw new DnieUnexpectedException("Cannot get the console object");
        }

        char [] password = console.readPassword ("("+title+")"+msg);
